...
class TransmissionTypeForm(forms.Form):
    """
    Formulario para la creación y edición de TransmissionType.
    """
    name = forms.CharField(
        label="Nombre",
        max_length=100,
        required=True,
        widget=forms.TextInput(attrs={"class": "form-control", "placeholder": "Ej: Automática"})
    )
...
class TaskTypeForm(forms.Form):
    """
    Formulario para la creación y edición de TaskType.
    """
    name = forms.CharField(
        label="Nombre",
        max_length=100,
        required=True,
        widget=forms.TextInput(attrs={"class": "form-control", "placeholder": "Ej: Cambio de Aceite"})
    )
    description = forms.CharField(
        label="Descripción",
        required=False,
